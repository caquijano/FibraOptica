  ...
  <nav class="main-header navbar navbar-expand navbar-dark navbar-navy">
    ...
    <form class="form-inline ml-3">
      <div class="input-group input-group-sm">
        <input name="buscarpor" class="form-control form-control-navbar" type="search" placeholder="Search" aria-label="Search">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="{{ asset('dist/img/user3-128x128.jpg') }}" alt="User Avatar" class="img-size-50 mr-3 img-circle">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  Nora Silvester
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
              <a href="{{ route('oportunidad')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Crear Oportunidad</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{('veroportunidad')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Listar Oportunidades</p>
                </a>
              </li>
            </ul>
          </li>
